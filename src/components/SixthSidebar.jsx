...
const SixthSidebar = () => {
  ...
  return (
    <div className="sidebar"style={{height:"949px",width:"54px",borderTop:"2px solid #FFD705",borderRadius:"10px",marginTop:"5px",borderBottom:"none"}}>
      <div className="sidebar-bottom"style={{gap:"20px"}}>
        ...
        <img src={mic} alt="Mic" className="sidebar-img" style={{height:"17px",width:"17px",marginTop:"20px"}}/>
        <img src={setting} alt="Settings" className="sidebar-img" style={{height:"16px",width:"16px",marginTop:"20px"}}/>
